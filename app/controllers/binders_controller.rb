class BindersController < ApplicationController
  ...
  def show
    ...
    @rss_path = binder_path(format: :rss)
  ...
  def search
    ...
    @rss_path = search_binders_path(format: :rss, q: params[:q])
