...
thinkit_serials = YAML.load_file('db/thinkit.serials.yml')
serials = gihyo_serials[0...250] + codezine_serials[0...100] +
  html5experts_serials[0...25] + thinkit_serials[0...125]
